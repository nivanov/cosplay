...
import org.cosplay.games.mir.station.MirCrewMember.*
...
import org.cosplay.games.mir.station.MirPlayerRole.*
...
/**
  ...
  * @param game
  */
case class MirFavGame(character: String, game: String) extends Serializable:
...
/**
  ...
  * @param author
  */
case class MirFavBook(title: String, author: String) extends Serializable:
...
/**
  ...
  * @param teams
  */
case class MirTeamSport(name: String, teams: Seq[String])
...
case class MirCrewMember(
    ...
    val favGames: Seq[MirFavGame] = for i <- 0 to CPRand.randInt(1, 3) yield CPRand.rand(nesGames)
...
/**
  *
  */
object MirCrewMember:
    private val sports: Seq[MirTeamSport] = Seq(
        MirTeamSport("Basketball", Seq(
    ...
    private val nesGames: Seq[MirFavGame] = Seq[(String, String)](
        ("Mario", "Super Mario"),
        ("Mario", "Super Mario 3"),
        ("Luigi", "Super Mario 3"),
        ("Yoshi", "Super Mario 3"),
    ...
    /**
      *
      */
    private def newChild(): MirPlayerChild =
    ...
    /**
      *
      */
    def newPlayer: MirCrewMember =
        val birth = CPRand.rand(towns)
        val home = CPRand.rand(towns)
        val kids = ArrayBuffer.empty[MirPlayerChild]
        ...
        MirCrewMember(
            ...
            home._1,
            home._2,
            CPRand.rand(MirPlayerRole.values.toSeq),
