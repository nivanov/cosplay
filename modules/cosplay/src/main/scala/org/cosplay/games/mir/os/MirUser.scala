...
object MirUser:
    ...
    /**
      ...
      * @param player
      */
    def apply(username: String, password: String, player: Option[MirCrewMember]): MirUser =
        ...
        new MirUser :
            ...
            override def getCrewMember: Option[MirCrewMember] = player
    ...
    def mkRoot(): MirUser =
        new MirUser:
            ...
            override def getCrewMember: Option[MirCrewMember] = None
...
/**
  *
  */
trait MirUser extends Serializable:
    /**
      *
      */
    def getCrewMember: Option[MirCrewMember]

    /**
      *
      */
    def crew: MirCrewMember =
        require(!isRoot)
        getCrewMember.get
