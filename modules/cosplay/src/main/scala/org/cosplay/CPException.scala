...
/**
  * CosPlay exception.
  *
  * Many methods throughout CosPlay API throw this exception. In most cases - there's no expected
  * recovery from these errors, such errors should be considered fatal and the game should be stopped.
