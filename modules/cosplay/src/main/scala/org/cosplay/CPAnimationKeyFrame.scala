...
/**
  ...
  *
  * @param animationId ID of the animation this key frame belongs to.
  * @param image Key frame image.
  * @param index Index of this key frame in the animation sequence.
  ...
  */
case class CPAnimationKeyFrame(
    animationId: String,
    image: CPImage,
    index: Int
)
